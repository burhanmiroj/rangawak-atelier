...
backToTopBTN.innerHTML = `<button class="w-16 h-16 hover:bg-white hover:bg-opacity-50 rounded-full animate-bounce transition-all duration-500 flex justify-center items-center opacity-0 fixed bottom-5 left-1/2 -ml-7 transform -translate-x-1/2 z-20">
